...
public class Lazy<T> {
   ...
   *
   * @param producer The Producer which will produce a value of type T when it is needed.
   * @param <T> The type of the Lazy object.
  ...
  /** A method which takes in a Transformer, transforms the value of the Lazy object into
   * a type of U (when needed), and then returns a new Lazy object with the updated value.
   *
  ...
  /** A method which takes in a Transformer, transforms the value of the Lazy object into
   * a Lazy object which stores the transformed value of type of U (when needed), and then returns
   * the created Lazy object with the transformed value inside. 
   *
   * @param transformation The Transformer which will transform the value.
   * @param <U> The type of the transformed value, and the type of the returned Lazy object.
   * @return Returns a Lazy of type U which will compute the transformed value only when get()
